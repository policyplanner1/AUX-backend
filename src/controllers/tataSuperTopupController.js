...
exports.calculateTATASuperTopupPremium = async (req, res) => {
    try {
        ...
        // TABLE NAME (tata plan premium table)
        ...
        // TATA SUPER-TOPUP PREMIUM LOOKUP
        ...
        // SUCCESS RESPONSE
        return res.json({
            message: "TATA Super Top-Up Premium Calculated",
            companyId,
            planId,
        ...
        console.error("TATA SuperTopup Error:", err);
