...
/**
 * Controller to calculate premiums for the BAJAJ company.
 *
 * BAJAJ rule:
...
exports.calculatePremium = async (req, res) => {
  try {
    ...
    if (parseInt(planId, 10) === 197 || parseInt(planId, 10) === 207) {
      // SPECIAL CONDITION FOR PLAN 197
      // For example: always use zone = 9
      const specialZone = 9;
    ...
    console.error('Error calculating BAJAJ premium:', err);
