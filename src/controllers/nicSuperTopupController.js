...
exports.calculateNICSuperTopupPremium = async (req, res) => {
    try {
        ...
        // TABLE NAME (national company + plan)
        ...
        // PREMIUM LOOKUP (Super Top-Up WITHOUT ZONE)
        ...
        // RESPONSE
        return res.json({
            message: "National Insurance Super Top-Up Premium Calculated",
            companyId,
            planId,
        ...
        console.error("NIC SuperTopup Error:", err);
